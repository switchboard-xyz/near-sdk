...
| -------- | -------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| Rust     | sbv2-near <br />[src](/rust/sbv2-near/), [Typedocs](https://docs.rs/sbv2-near/latest/sbv2_near/)                                 | Rust crate to deserialize and read Switchboard data feeds |
| JS       | @switchboard-xyz/near.js <br />[src](/javascript/near.js), [Typedocs](https://docs.switchboard.xyz/api/@switchboard-xyz/near.js) | Typescript package to interact with Switchboard V2        |
